...
export const SchemaTags = ({ softwareAppSchema, organizationSchema }: SchemaTagsProps) => {
  return (
    <Helmet>
      <title>GTMCentric - Join the Waitlist for AI-Powered GTM Solutions</title>
      ...
      <meta property="og:title" content="GTMCentric - Join the Waitlist for AI-Powered GTM Solutions" />
      ...
      <meta name="twitter:title" content="GTMCentric - Join the Waitlist for AI-Powered GTM Solutions" />
