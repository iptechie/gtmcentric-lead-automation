  ...
  return (
    <div className="min-h-screen bg-[#1A1F2C]">
      ...
      <section className="py-10 md:py-12 relative">
        <div className="container max-w-7xl px-4 sm:px-6 lg:px-8 mx-auto">
          <div className="text-center animate-fade-in">
            <h2 className="text-3xl font-bold sm:text-4xl text-foreground bg-clip-text text-transparent bg-gradient-to-r from-white to-white/80 mb-8">
            ...
            <div className="relative mx-auto max-w-5xl px-4">
              <div className="relative grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                {[
                  {
                    title: "Create GTM Planning",
                    description: "In seconds with AI recommendation.",
                    color: "from-[#8B5CF6] to-[#A78BFA]",
                    shadowColor: "shadow-purple-500/20"
                  },
                  {
                    title: "Capture Leads",
                    description: "From anywhere—web, email, social.",
                    color: "from-[#D946EF] to-[#EC4899]",
                    shadowColor: "shadow-pink-500/20"
                  },
                  {
                    title: "AI-powered Lead Scoring",
                    description: "Focus on hot prospects.",
                    color: "from-[#8B5CF6] to-[#A78BFA]",
                    shadowColor: "shadow-purple-500/20"
                  },
                  {
                    title: "Automate Follow-ups",
                    description: "And watch conversions soar.",
                    color: "from-[#D946EF] to-[#EC4899]",
                    shadowColor: "shadow-pink-500/20"
                  },
                  {
                    title: "Seamless Integration",
                    description: "With Gmail, Outlook, Slack, and Mailchimp.",
                    color: "from-[#8B5CF6] to-[#A78BFA]",
                    shadowColor: "shadow-purple-500/20"
                  },
                  {
                    title: "Dedicated Dashboard",
                    description: "For managers to review performance.",
                    color: "from-[#D946EF] to-[#EC4899]",
                    shadowColor: "shadow-pink-500/20"
                  },
                  {
                  ...
                  },
                  {
                    ...
                    description: "For seamless communication with prospects.",
                    color: "from-[#D946EF] to-[#EC4899]",
                    shadowColor: "shadow-pink-500/20"
                  },
                  {
                    title: "Affordable Pricing",
                    description: "Plans start at $10/month.",
                    color: "from-[#8B5CF6] to-[#A78BFA]",
                    shadowColor: "shadow-purple-500/20"
                  },
                ].map((feature, index) => (
                  <div
                    key={index}
                    className={`relative group h-full rounded-xl p-1 bg-gradient-to-br ${feature.color} transition-all duration-300 hover:scale-105 ${feature.shadowColor} hover:shadow-xl`}
                  >
                    <div className="bg-[#1A1F2C]/95 h-full rounded-lg p-6 backdrop-blur-sm flex flex-col">
                      <div className="flex items-center mb-3">
                        <Check className="w-5 h-5 mr-2 text-transparent bg-clip-text bg-gradient-to-br from-[#8B5CF6] to-[#D946EF]" />
